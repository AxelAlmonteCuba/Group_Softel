...
4. **`TRABAJADOR`**: Registro de gastos individuales contra una caja chica autorizada con carga de comprobantes, creación, actualización, generación y descarga de reportes fotográficos cuando cuente con autorización. En fases futuras registra odómetro/horómetro de motores, entrega/devolución de equipos autorizados y solicita reposición de EPP. **No aprueba gastos, cajas ni cambios financieros**.
